				...
				<div class="hidden xl:flex gap-[20px]">
					<?php foreach ( $mrent_tabs as $mrent_tab ) : ?>
						<button
							...
							class="mrent-tab-pill bg-[#252426] text-mrent-white aria-[current=true]:bg-mrent-white aria-[current=true]:text-mrent-black flex items-center justify-center rounded-[15px] h-[65px] w-[300px] px-[15px] font-[500] text-[20px] whitespace-nowrap transition-colors cursor-pointer"
						>
