		...
		<div class="max-w-[1720px] mx-auto flex justify-center">
			<div class="w-full max-w-[330px] xl:max-w-full flex flex-col gap-[30px] xl:gap-[50px] items-center">
				<div class="flex flex-col gap-[15px] xl:gap-[20px] items-center text-center text-white w-full">
					...
					<?php if ($mrent_lead !== '') : ?>
						<p class="text-[clamp(14px,12.54px+0.39vw,20px)] leading-[1.2] w-full max-w-150">
				...
				<?php if ($mrent_cta_label) : ?>
					<a
						...
						class="bg-mrent-yellow hover:bg-[#FFF831] flex items-center justify-center rounded-[15px] h-[55px] xl:h-[65px] w-full xl:w-[300px] px-[15px] text-mrent-black font-display font-medium text-[clamp(14px,12.54px+0.39vw,18px)] leading-none whitespace-nowrap transition-colors">
