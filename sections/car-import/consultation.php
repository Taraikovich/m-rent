		...
		<div class="flex flex-col xl:justify-between xl:self-center gap-[30px] xl:gap-10">
			...
			<div class="flex flex-col gap-[20px] xl:gap-[40px]">
				...
				<div class="flex flex-col gap-[15px] xl:gap-[30px]">
					<p class="font-display font-bold text-[clamp(16px,14.06px+0.52vw,24px)] text-mrent-white leading-[1.24]">
				...
				<?php if ($mrent_subscribe_ig || $mrent_subscribe_tg) : ?>
					<div class="flex flex-col xl:flex-row gap-[10px] xl:gap-[30px]">
						<?php if ($mrent_subscribe_ig) : ?>
							<a href="<?php echo esc_url($mrent_subscribe_ig); ?>" class="self-start font-display font-medium text-[clamp(14px,13.03px+0.26vw,18px)] text-mrent-white underline underline-offset-2 hover:opacity-80 transition-opacity" target="_blank" rel="noopener noreferrer">
								<?php esc_html_e('Подписаться в Instagram', 'm-rent'); ?>
							</a>
						<?php endif; ?>
						<?php if ($mrent_subscribe_tg) : ?>
							<a href="<?php echo esc_url($mrent_subscribe_tg); ?>" class="self-start font-display font-medium text-[clamp(14px,13.03px+0.26vw,18px)] text-mrent-white underline underline-offset-2 hover:opacity-80 transition-opacity" target="_blank" rel="noopener noreferrer">
