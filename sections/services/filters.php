			...
			<div class="hidden xl:flex gap-[20px] items-stretch">
				...
				?>
					<a
						...
						class="flex-1 min-w-0 h-[65px] flex items-center justify-center rounded-[15px] px-[15px] text-[18px] font-[500] leading-[1.2] text-center whitespace-nowrap transition-colors <?php echo esc_attr($skin); ?>">
						<?php echo esc_html($pill['label']); ?>
					</a>
				<?php endforeach; ?>
			</div>
