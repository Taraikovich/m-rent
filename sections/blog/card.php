...
<a
	...
	<div class="flex flex-col gap-[15px] xl:gap-[20px] w-full flex-1">
		<span class="text-mrent-white/50 font-[400] text-[clamp(16px,calc(15.51px+0.13vw),18px)] leading-[1.2]">
			<?php echo esc_html($mrent_date); ?>
		</span>
		<h3 class="text-mrent-white font-[800] text-[clamp(16px,calc(16.6px+0.91vw),24px)] leading-[1.1] group-hover:text-mrent-yellow transition-colors">
			<?php the_title(); ?>
		</h3>
		<?php if ($mrent_excerpt) : ?>
			...
			<p class="mrent-text-fade font-[400] text-[clamp(14px,calc(11.57px+0.65vw),18px)] leading-[1.2] line-clamp-3 xl:line-clamp-4">
				<?php echo esc_html($mrent_excerpt); ?>
			</p>
		<?php endif; ?>
	</div>

	<span class="text-mrent-yellow font-[500] text-[clamp(14px,calc(15.09px+0.78vw),18px)] underline decoration-solid group-hover:text-[#FFF831] transition-colors">
