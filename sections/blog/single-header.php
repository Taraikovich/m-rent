	...
	<div class="px-[15px] xl:px-[100px]">
		<div class="max-w-[1720px] mx-auto flex flex-col gap-[15px] xl:gap-[30px] leading-[1.2]">
			<div class="flex flex-col-reverse xl:flex-row xl:items-start xl:justify-between gap-[10px] xl:gap-[40px]">
				<h1 class="text-mrent-white font-[700] text-[28px] xl:text-[74px] xl:max-w-[1066px]">
					<?php the_title(); ?>
				</h1>
				<time
					datetime="<?php echo esc_attr( get_the_date( 'c' ) ); ?>"
					class="text-mrent-white/50 font-[400] text-[16px] xl:text-[30px] whitespace-nowrap shrink-0"
				>
			...
			<?php if ( $mrent_lead !== '' ) : ?>
				<p class="text-mrent-white font-[400] text-[16px] xl:text-[30px]">
