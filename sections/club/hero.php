...
<section class="relative bg-mrent-black">
	...
	<?php /* Текст-overlay (h1 + p + кнопка).
	         ...
	         Desktop (≥2xl): абсолютное позиционирование, `top-[515px]` внутри
	         900px-картинки. */ ?>
	<div class="relative z-10 -mt-[125px] px-[15px] pb-[40px] 2xl:absolute 2xl:inset-x-0 2xl:top-[515px] 2xl:mt-0 2xl:pb-0 2xl:px-[100px]">
