 ...
 *
 * Контент: ACF-группа «Главная», таб «Почему выбирают нас», репитер
 * `home_why_us` (ровно 6 карточек: иконка + заголовок + описание).
 *
 * Layout (Figma 230:445 desktop / 2317:3541 mobile):
 *   • Mobile: заголовок 28px → Swiper из 2 слайдов, в каждом по 3 карточки
 *     стопкой (gap 10), под ним 2 полоски-пагинации.
 *   • Desktop: заголовок 74px → статичная сетка 3 кол × 2 строки (gap 30,
 *     карточки w-553). Swiper не инициализируется.
 *
 * Один DOM на оба брейкпоинта: на xl+ обёртки `.swiper-slide` и внутренний
 * `flex flex-col` сворачиваются через `xl:!contents`, и 6 карточек становятся
	...
	<div class="px-[15px] xl:px-[100px]">
		<div class="max-w-[1720px] mx-auto flex flex-col items-center gap-[30px] xl:gap-[60px]">
			...
			<h2 class="font-[700] text-[28px] xl:text-[74px] leading-[1.2] text-mrent-white text-center">
				<?php esc_html_e( 'Почему выбирают нас', 'm-rent' ); ?>
			</h2>
