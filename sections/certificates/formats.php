...
<section class="bg-mrent-black px-[15px] xl:px-[100px] pt-[40px] xl:pt-[100px] pb-[40px] xl:pb-[100px]">
	<div class="max-w-[1720px] mx-auto flex flex-col gap-[30px] xl:gap-[60px]">
		...
		<h2 class="font-display font-bold text-mrent-white text-[28px] xl:text-[74px] leading-[1.2]">
		...
		<ul
			...
			?>
				...
				$mrent_li_cls = trim($mrent_span_cls . ' relative overflow-hidden rounded-[15px] border border-[#302F31] h-[280px] xl:h-[600px]' . ($mrent_hidden_mobile ? ' hidden xl:block' : ''));
				?>
				<li
					...
					<div class="relative h-full flex flex-col items-start gap-[20px] xl:gap-[30px] p-[20px] xl:p-[50px]">
						<?php if ($mrent_card_title !== '') : ?>
							<h3 class="font-display font-[600] text-mrent-white text-[18px] xl:text-[35px] leading-[1.2] max-w-[420px]">
						...
						<a
							...
							class="font-display font-medium text-mrent-white text-[16px] xl:text-[30px] leading-none underline underline-offset-4 hover:text-mrent-yellow transition-colors">
		...
		<?php if ($mrent_has_toggle) : ?>
			<button
				type="button"
				class="xl:hidden self-center font-display font-medium text-mrent-yellow text-[18px] leading-none underline underline-offset-4 hover:opacity-80 transition-opacity"
				data-formats-toggle
