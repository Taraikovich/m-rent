	...
	<div class="px-[15px] xl:px-[100px]">
		<div class="max-w-[1720px] mx-auto flex flex-col gap-[30px] xl:gap-[60px]">
			...
			<div class="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-[20px] xl:gap-[30px]">
				<h1 class="font-[700] text-[28px] xl:text-[74px] leading-[1.2] text-mrent-white text-center xl:text-left">
					<?php echo esc_html( $mrent_title ); ?>
				</h1>
				<a href="<?php echo esc_url( $mrent_cta_url ); ?>" class="hidden xl:flex bg-mrent-yellow hover:bg-[#FFF831] transition-colors items-center justify-center rounded-[15px] h-[65px] w-[300px] px-[15px] text-mrent-black font-[500] text-[20px] leading-none shrink-0">
							...
							<article class="bg-[#252426] border border-[#302f31] rounded-[15px] p-[25px] xl:p-[35px] flex flex-col gap-[20px] w-full h-full">
								<div class="flex flex-col gap-[15px]">
									<div class="flex flex-col gap-[15px] xl:gap-[20px]">
										...
										<p class="font-[600] text-[22px] xl:text-[30px] leading-[1.2] text-mrent-white">
											<?php echo esc_html( $mrent_item['name'] ); ?>
										</p>
									</div>
									<?php if ( $mrent_item['car_label'] !== '' ) : ?>
										<p class="font-[400] text-[14px] xl:text-[18px] leading-[1.3] text-mrent-white">
											<?php echo esc_html( $mrent_item['car_label'] ); ?>
										</p>
									<?php endif; ?>
								</div>
								<p class="font-[400] text-[16px] xl:text-[24px] leading-[1.2] text-mrent-white">
			...
			<a href="<?php echo esc_url( $mrent_cta_url ); ?>" class="xl:hidden bg-mrent-yellow hover:bg-[#FFF831] transition-colors flex items-center justify-center rounded-[15px] h-[55px] w-full px-[15px] text-mrent-black font-[500] text-[18px] leading-none">
				<?php echo esc_html( $mrent_cta_label ); ?>
			</a>
