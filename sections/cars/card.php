	...
	<a href="<?php echo esc_url($mrent_permalink); ?>"<?php echo $mrent_hover_url ? ' data-mrent-card-flip' : ''; ?> class="group block relative rounded-[15px] overflow-hidden aspect-[5/7] min-h-[130px] max-h-[150px] xl:max-h-[300px] xl:aspect-auto xl:h-[300px] xl:min-h-0 xl:max-h-none bg-[#252426] shrink-0">
		<?php if ($mrent_thumb_url) : ?>
			<img
				...
				class="absolute inset-0 size-full object-cover transition-opacity duration-300<?php echo $mrent_hover_url ? ' group-hover:opacity-0 group-data-[flipped=true]:opacity-0' : ''; ?>"
				loading="lazy"
				decoding="async">
		<?php endif; ?>
		<?php if ($mrent_hover_url) : ?>
			<img
				...
				alt=""
				aria-hidden="true"
				class="absolute inset-0 size-full object-cover opacity-0 group-hover:opacity-100 group-data-[flipped=true]:opacity-100 transition-opacity duration-300"
				loading="lazy"
				decoding="async">
		<?php endif; ?>
	</a>
